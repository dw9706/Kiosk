...
public class Main {
    public static void main(String[] args) {
        ...
        Menu drinksMenu = new Menu("Drinks",
                new MenuItem("Shack-made Lemonade", 3.9, "레몬주스, 설탕, 물로 만든 수제 레모네이드"),
                new MenuItem("Fifty/Fifty", 3.9, "레몬에이드와 아이스티가 반반 섞인 시원한 음료"),
                new MenuItem("Organic Apple Juice", 2.9, "유기농 사과즙"),
                new MenuItem("Fountain Soda", 2.5, "코카콜라·스프라이트 등 탄산음료")
        );
        Menu dessertMenu = new Menu("Desserts",
                new MenuItem("Vanilla Shake", 5.9, "바닐라 아이스크림과 우유를 블렌딩한 쉐이크"),
                new MenuItem("Chocolate Shake", 5.9, "초콜릿 아이스크림과 우유를 블렌딩한 쉐이크"),
                new MenuItem("Chocolate Chip Cookie", 3.0, "따뜻한 초코칩 쿠키"),
